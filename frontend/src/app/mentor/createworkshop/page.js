...
export default function App() {
  ...
  const handleSubmit = (e) => {
    ...
    alert(
      "Workshop created successfully! It will be reviewed and published within 24 hours."
    );
  };
        ...
        <main className="flex-1 md:ml-0 p-6">
          ...
          <div className="mb-8">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Design a special event or masterclass to share your expertise
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-2 text-sm text-gray-600">
              <span className="w-6 h-6 bg-primary text-white rounded-full flex items-center justify-center text-xs font-semibold">
                1
              </span>
              <span className="text-primary font-medium">Workshop Details</span>
              <i className="fas fa-chevron-right text-gray-300"></i>
              <span className="w-6 h-6 bg-gray-300 text-gray-600 rounded-full flex items-center justify-center text-xs font-semibold">
                2
              </span>
          ...
          <div className="bg-white rounded-xl border border-gray-200">
            <div className="border-b border-gray-200 p-6">
              ...
              <p className="text-gray-600">
                Fill in the details to create your workshop
              </p>
            </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="md:col-span-2">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Make it descriptive and engaging for participants
                    </p>
                  </div>
                  <div>
                    <label className="block text-sm font-semibold text-gray-900 mb-2">
                ...
                <div>
                  ...
                  <div className="flex justify-between items-center mt-1">
                    <p className="text-xs text-gray-500">
                      Help participants understand what to expect
                    </p>
                    <span
                      className={`text-xs ${
                  ...
                  <div className="mb-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                      <label className="cursor-pointer">
                        ...
                        />
                        <div
                          className={`border-2 rounded-lg p-4 text-center transition-all duration-200 hover:border-primary ${
                            deliveryMode === "online"
                  ...
                  {(deliveryMode === "in-person" ||
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          type="text"
                          placeholder="e.g., Birmingham Community Centre"
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                        />
                      </div>
                      <div>
                ...
                <div className="border-t border-gray-200 pt-8">
                  ...
                  <div className="grid md:grid-cols-3 gap-6 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Workshop runs if minimum is met
                      </p>
                    </div>
                    <div>
                      <label className="block text-sm font-semibold text-gray-900 mb-2">
                ...
                <div className="border-t border-gray-200 pt-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <textarea
                        rows="4"
                        placeholder="List any materials, clothing, or items participants need for the workshop..."
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                      ></textarea>
                      <p className="text-xs text-gray-500 mt-1">
                        e.g., comfortable clothing, notebook, water bottle
                      </p>
                    </div>
                    <div>
                      <label className="block text-sm font-semibold text-gray-900 mb-2">
                      ...
                      <textarea
                        rows="4"
                        placeholder="Describe materials, handouts, or refreshments you'll provide..."
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                      ></textarea>
                      <p className="text-xs text-gray-500 mt-1">
                        e.g., practice sheets, tea/coffee, instruments
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="border-t border-gray-200 pt-8">
                  <div className="flex flex-col sm:flex-row gap-4 sm:justify-between">
                    ...
                    <div className="flex space-x-4">
                      <button
                        type="button"
                        className="px-6 py-3 border border-primary text-primary rounded-lg hover:bg-primary-light transition-colors"
                      >
                        Schedule for Later
                      </button>
                      <button
