...
const OnBoarding = () => {
  ...
  const handleRemoveLanguage = (languageToRemove) => {
    if (languageToRemove !== 'english') { // Prevent removing English
      setFormData(prev => ({
        ...prev,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post('https://rootsnwings-api-944856745086.europe-west2.run.app/user-onboarding/mentor', requestBody);
console.log(response,'response response response');
      ...
      if (response) {
        ...
        // Show success alert
        alert('🎉 Profile submitted successfully! You will receive confirmation within 24-48 hours. Redirecting to mentor dashboard...');
      ...
      alert('❌ There was an error submitting your profile. Please try again or contact support if the problem persists.');
    } finally {
  ...
  const renderStepContent = () => {
    switch (currentStep) {
            ...
            <div className="bg-gray-50 rounded-lg p-6 mb-8">
              ...
              <div className="space-y-3 text-left">
                <label className="flex items-center space-x-3 cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50">
                  ...
                  />
                  <span className="text-gray-700">Individual mentor (1-on-1)</span>
                </label>
                <label className="flex items-center space-x-3 cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50">
                  <input
                    type="radio"
            ...
            <div className="lg:col-span-1">
              <div className="bg-blue-50 rounded-lg p-6 sticky top-4">
                <h3 className="font-semibold text-blue-800 mb-3">
                  <span role="img" aria-label="lightbulb">💡</span> Good to Know
                </h3>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-gray-50 rounded-lg p-4">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">
                    <span role="img" aria-label="graduation cap">🎓</span> Teaching levels
                  </h3>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">
                    <span role="img" aria-label="people">👥</span> Age groups
                  </h3>
                  <div className="space-y-3">
            ...
            <div className="space-y-6">
              <div>
                <label htmlFor="title" className="block text-lg font-semibold text-gray-900 mb-3">
                  <span role="img" aria-label="pencil">✏️</span> Title of your ad
                </label>
                <textarea
                  id="title"
                  name="title"
              ...
              <div>
                <label htmlFor="aboutYou" className="block text-lg font-semibold text-gray-900 mb-3">
                  <span role="img" aria-label="person">🧑</span> About you
                </label>
                <p className="text-gray-600 mb-3">
                  Share your qualifications, experience, passion, and personal message to students
                </p>
                <textarea
                  id="aboutYou"
                  name="aboutYou"
      ...
      case 4:
        return (
          <>
            ...
            <div className="mb-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">
                <span role="img" aria-label="pin">📍</span> Your location
              </h3>
              ...
              <div className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                <label className="flex items-center space-x-3 cursor-pointer">
                  ...
                  <span className="font-medium">
                    <span role="img" aria-label="house">🏠</span> At my home
                  </span>
                </label>
              </div>
              <div className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                <label className="flex items-center space-x-3 cursor-pointer">
                  ...
                  />
                  <span className="font-medium">
                    <span role="img" aria-label="car">🚗</span> I can travel
                  </span>
                </label>
              </div>
              <div className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                <label className="flex items-center space-x-3 cursor-pointer">
                  ...
                  />
                  <span className="font-medium">
                    <span role="img" aria-label="globe">🌐</span> Online lessons
                  </span>
                </label>
              </div>
            </div>
      ...
      case 5:
        return (
          <>
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Languages & Safety</h2>
            ...
            <div className="mb-8">
              ...
              <div className="space-y-4">
                ...
                <div id="added-languages">
                  {formData.languages.filter(lang => lang !== 'english').map(lang => (
                ...
                <div>
                  ...
                  <div className="flex space-x-3">
                    ...
                    >
                      ...
                      {LANGUAGES.filter(lang => !formData.languages.includes(lang.value)).map(lang => (
            ...
            <div className="border-t border-gray-200 pt-8">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Your safety and ours</h3>
              <p className="text-gray-600 mb-6">Roots & Wings is committed to creating a safe environment. Please confirm the following:</p>
              <div className="bg-gray-50 rounded-lg p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <label htmlFor="dbsCheck" className="text-lg font-semibold text-gray-900 cursor-pointer">
      ...
      case 6:
        return (
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-sm text-gray-500 mt-4">Recommended: Clear headshot, good lighting, professional appearance</p>
          </div>
        );
              ...
              <div className="space-y-6">
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) => handlePricingChange('oneOnOneRate', e.target.value)}
                    />
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  <div className="flex items-center space-x-3">
                    <input
                      ...
                      onChange={(e) => handlePricingChange('firstsessionfree', e.target.checked)}
                    />
                ...
                <div className="bg-blue-50 rounded-lg p-6 mt-8">
                  <h3 className="text-lg font-semibold text-blue-800 mb-4">
                    <span role="img" aria-label="checkmark">✅</span> Ready to submit your profile?
                  </h3>
                  <p className="text-blue-700 mb-4">
                    Your mentor profile will be reviewed within 24-48 hours. Once approved, students can start booking sessions with you!
                  </p>
                  <button
                    type="submit"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-blue-800">Roots & Wings</h1>
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-4">
              <span className="text-sm text-gray-600">
                Step <span className="font-semibold">{currentStep}</span> of <span className="font-semibold">{totalSteps}</span>
              </span>
          ...
          <div className="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            <div className="flex items-center">
              ...
              <span className="text-sm text-yellow-800">
                {currentStep === 1 && "Please select your teaching role to continue."}
                {currentStep === 2 && "Please select at least one subject, level, and age group."}
                {currentStep === 3 && "Please complete both the title (50+ chars) and about you (150+ chars) sections."}
                {currentStep === 4 && "Please fill in your city, country, and select at least one teaching mode."}
                {currentStep === 5 && "Please confirm your DBS check status to continue."}
                {currentStep === 7 && "Please set pricing for at least one session type."}
              </span>
            </div>
          </div>
        )}
