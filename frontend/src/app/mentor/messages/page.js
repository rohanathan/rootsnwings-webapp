              ...
              <div className="flex-1 p-4 space-y-4 overflow-y-auto max-h-80">
                  ...
                  <div className="flex-1">
                    <div className="bg-gray-100 rounded-lg rounded-tl-none p-3 max-w-md">
                      <p className="text-sm text-gray-900">
                        Hi Priya ma'am! Thank you so much for today's session. I
                        really enjoyed learning the new taal patterns.
                      </p>
                    </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <div className="bg-gray-100 rounded-lg rounded-tl-none p-3 max-w-md">
                      <p className="text-sm text-gray-900">
                        I have a question about the hand movements we practiced.
                        Could you share the reference video you mentioned?
                      </p>
                    </div>
                ...
                <div className="flex items-start space-x-3 justify-end">
                  <div className="flex-1 flex justify-end">
                    <div className="bg-primary text-white rounded-lg rounded-tr-none p-3 max-w-md">
                      <p className="text-sm">
                        I'm so glad you enjoyed the session! Yes, I'll send you
                        the video link for the hasta mudras. Keep practicing the
                        basic movements we covered.
                      </p>
                    </div>
                  </div>
                  <div className="w-8 h-8 bg-primary rounded-full flex items-center justify-center">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <div className="bg-gray-100 rounded-lg rounded-tl-none p-3 max-w-md">
                      <p className="text-sm text-gray-900">
                        Perfect, thank you! One more thing - what time should I
                        arrive for tomorrow's session?
                      </p>
                    </div>
