...
const Messages = () => {
    ...
    const conversationItems = [
        {
            ...
            name: 'Ananya Mehta',
            time: '2m ago',
            message: "Thank you for the session today! I have a question about...",
        ...
        },
        {
            ...
            name: 'Raj Kumar',
            time: '1h ago',
            message: "Hi Priya ma'am, I need to reschedule tomorrow's session...",
        ...
        },
        {
            ...
            time: '3h ago',
            message: "Kavya Singh: Can we practice the new sequence before...",
            status: '6 members',
        ...
        },
        {
            ...
            name: 'Shreya Patel',
            time: '1d ago',
            message: "Perfect! Looking forward to our session tomorrow. Thank you!",
            status: 'Advanced',
        ...
        },
        {
            ...
            name: 'Maya Rajan',
            time: '2d ago',
            message: "Got it! I'll practice the footwork and see you on Wednesday.",
            status: 'Intermediate',
            bgColor: 'bg-blue-500',
            statusBg: 'bg-orange-100',
            statusText: 'text-orange-800',
        ...
        },
        {
            ...
            icon: <UsersIcon className="h-4 w-4" />,
            time: '3d ago',
            message: "Thanks everyone for the wonderful discussion on...",
            status: '6 members',
            bgColor: 'bg-teal-500',
    ...
    return (
        <div className="bg-background font-sans">
                ...
                <div className="flex items-center justify-between px-6 py-4">
                    ...
                    <div className="relative" ref={profileDropdownRef}>
                        <button id="profile-dropdown-btn" className="flex items-center space-x-3 hover:bg-gray-50 rounded-lg px-3 py-2 transition-colors" onClick={toggleProfileDropdown}>
                            ...
                            <ChevronDownIcon className="text-gray-400 text-sm" />
                        </button>
                        ...
                        <div id="profile-dropdown" className={`${isProfileDropdownOpen ? '' : 'hidden'} absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 py-2`}>
                            ...
                            <a href="#" className="flex items-center space-x-3 px-4 py-2 text-gray-700 hover:bg-gray-50">
                                <CogIcon className="text-gray-400 h-5 w-5" />
                                <span>Settings</span>
                            </a>
                            <a href="#" className="flex items-center space-x-3 px-4 py-2 text-gray-700 hover:bg-gray-50">
                                <QuestionCircleIcon className="text-gray-400 h-5 w-5" />
                                <span>Help & Support</span>
                            </a>
                            <hr className="my-2" />
                            <a href="#" className="flex items-center space-x-3 px-4 py-2 text-red-600 hover:bg-red-50">
                                <SignOutIcon className="text-red-400 h-5 w-5" />
                                <span>Log Out</span>
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="p-6">
                        ...
                        <div className="space-y-2">
                            {navItems.map((item, index) => (
                                <a key={index} href={item.href} className="flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 transition-all duration-200 ease-in-out hover:bg-primary-light hover:translate-x-1">
                                    {item.icon}
                                    <span className="font-medium">{item.name}</span>
                                </a>
                            ))}
                            <a href={currentNav.href} className="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-200 ease-in-out hover:bg-primary-light hover:translate-x-1 bg-primary text-white">
                                {currentNav.icon}
                ...
                <main className="flex-1 md:ml-0 p-6">
                    ...
                    <div className="flex items-center justify-between mb-8 flex-wrap gap-4">
                        <div>
                            ...
                            <p className="text-gray-600">Communicate with your students and manage conversations</p>
                        </div>
                        ...
                        {messageStats.map((stat, index) => (
                            <div key={index} className="bg-white rounded-xl p-6 border border-gray-200">
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    <span className={`${stat.titleColor} text-sm font-medium`}>{stat.title}</span>
                                </div>
                        ...
                        <div className="lg:col-span-1 bg-white rounded-xl border border-gray-200">
                            <div className="p-4 border-b border-gray-200">
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <div className="flex space-x-2">
                                        <button className="text-xs px-3 py-1 bg-primary text-white rounded-full">All</button>
                                        <button className="text-xs px-3 py-1 bg-gray-100 text-gray-600 rounded-full hover:bg-gray-200">Unread</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="divide-y divide-gray-100 max-h-96 overflow-y-auto">
                                {conversationItems.map((item, index) => (
                                    <div key={index} className={`p-4 hover:bg-gray-50 cursor-pointer border-l-4 ${item.borderColor} ${item.unreadBg}`}>
                                        <div className="flex items-start space-x-3">
                                            <div className={`w-10 h-10 ${item.bgColor} rounded-full flex items-center justify-center`}>
                                                {item.icon ? <span className="text-white text-sm">{item.icon}</span> : <span className="text-white font-semibold text-sm">{item.initials}</span>}
                                            </div>
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="flex items-center justify-between mt-2">
                                                    <span className={`text-xs ${item.statusBg} ${item.statusText} px-2 py-1 rounded-full`}>{item.status}</span>
                                                    {item.checked ? <i className="fas fa-check text-gray-400 text-xs"></i> : <div className={`w-2 h-2 ${item.dotColor} rounded-full`}></div>}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="lg:col-span-2 bg-white rounded-xl border border-gray-200 flex flex-col">
                            ...
                            <div className="p-4 border-b border-gray-200 flex items-center justify-between">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-gray-900">Ananya Mehta</h4>
                            ...
                            <div className="flex-1 p-4 space-y-4 overflow-y-auto max-h-80">
                                ...
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div className="flex-1">
                                        <div className="bg-gray-100 rounded-lg rounded-tl-none p-3 max-w-md">
                                            <p className="text-sm text-gray-900">Hi Priya ma'am! Thank you so much for today's session. I really enjoyed learning the new taal patterns.</p>
                                        </div>
                                ...
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div className="flex-1">
                                        <div className="bg-gray-100 rounded-lg rounded-tl-none p-3 max-w-md">
                                            <p className="text-sm text-gray-900">I have a question about the hand movements we practiced. Could you share the reference video you mentioned?</p>
                                        </div>
                                ...
                                <div className="flex items-start space-x-3 justify-end">
                                    <div className="flex-1 flex justify-end">
                                        <div className="bg-primary text-white rounded-lg rounded-tr-none p-3 max-w-md">
                                            <p className="text-sm">I'm so glad you enjoyed the session! Yes, I'll send you the video link for the hasta mudras. Keep practicing the basic movements we covered.</p>
                                        </div>
                                    </div>
                                    <div className="w-8 h-8 bg-primary rounded-full flex items-center justify-center">
                                ...
                                <div className="flex justify-center">
                                    <div className="bg-gray-50 border border-gray-200 rounded-lg px-3 py-2">
                                        <p className="text-xs text-gray-600 flex items-center">
                                            <VideoIcon className="mr-2 text-green-500" />
                                            Priya shared: Kathak_Hasta_Mudras_Tutorial.mp4
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div className="flex-1">
                                        <div className="bg-gray-100 rounded-lg rounded-tl-none p-3 max-w-md">
                                            <p className="text-sm text-gray-900">Perfect, thank you! One more thing - what time should I arrive for tomorrow's session?</p>
                                        </div>
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div className="flex-1 relative">
                                        <input type="text" 
                                               ...
                                               defaultValue="Tomorrow's session is at 3:00 PM. See you then!" />
                        ...
                        <div className="bg-white rounded-xl border border-gray-200 p-6">
                            ...
                            <div className="space-y-3">
                                <button className="w-full text-left p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                    <p className="font-medium text-gray-900 text-sm">Session Reminder</p>
                                    <p className="text-xs text-gray-600 mt-1">Reminder: Your session is scheduled for tomorrow at [time]</p>
                                </button>
                                <button className="w-full text-left p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                    <p className="font-medium text-gray-900 text-sm">Practice Feedback</p>
                                    <p className="text-xs text-gray-600 mt-1">Great progress in today's session! Keep practicing...</p>
                                </button>
                                <button className="w-full text-left p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                    <p className="font-medium text-gray-900 text-sm">Homework Assignment</p>
                                    <p className="text-xs text-gray-600 mt-1">For next session, please practice the following...</p>
                                </button>
                                <button className="w-full text-left p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                                    <p className="font-medium text-gray-900 text-sm">Encouragement</p>
                                    <p className="text-xs text-gray-600 mt-1">You're doing excellent work! Keep up the dedication...</p>
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-xl border border-gray-200 p-6">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-sm font-medium text-gray-900">New message from Ananya Mehta</p>
                                ...
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-sm font-medium text-gray-900">Raj Kumar requested session reschedule</p>
                                ...
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-sm font-medium text-gray-900">Weekend Kathak Batch group activity</p>
                                ...
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-sm font-medium text-gray-900">Shared practice video with Maya Rajan</p>
                                ...
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-sm font-medium text-gray-900">Shreya Patel left a 5-star review</p>
            ...
            <div id="sidebar-overlay" className={`${isSidebarOpen ? '' : 'hidden'} fixed inset-0 bg-black bg-opacity-50 z-20 md:hidden`} onClick={toggleSidebar}></div>
        </div>
    );
};
