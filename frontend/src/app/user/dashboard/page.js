...
const Dashboard = () => {
    ...
    useEffect(() => {
        const handleClickOutside = (event) => {
            if (isProfileDropdownOpen && !event.target.closest('#profile-dropdown-btn') && !event.target.closest('#profile-dropdown')) {
                ...
                <div className="flex items-center justify-between px-6 py-4">
                    ...
                    <div className="hidden md:flex items-center space-x-2 bg-gray-100 rounded-lg p-1">
                        <button
                            ...
                            className={`profile-switch-btn px-4 py-2 rounded-md font-medium transition-all ${activeProfile === 'adult' ? 'bg-white text-gray-700 shadow-sm' : 'text-gray-600 hover:bg-white'}`}
                        >
                        ...
                        <button
                            ...
                            className={`profile-switch-btn px-4 py-2 rounded-md font-medium transition-all ${activeProfile === 'family' ? 'bg-white text-gray-700 shadow-sm' : 'text-gray-600 hover:bg-white'}`}
                        >
                ...
                <main className="flex-1 md:ml-0">
                        ...
                        <div className="max-w-7xl mx-auto">
                            <div className="flex flex-col md:flex-row md:items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-gray-600">Your family learning journey continues today</p>
                                </div>
                    ...
                    <div className="max-w-7xl mx-auto px-6 py-8">
                        ...
                        <section className="mb-8">
                            <h2 className="text-xl font-semibold text-gray-900 mb-6">Family Learning Overview</h2>
                                    ...
                                    <div className="space-y-4">
                                            ...
                                            <div className="flex items-start space-x-4">
                                                ...
                                                <div className="flex-1">
                                                    <div className="flex items-center justify-between">
                                                        <h4 className="font-medium text-gray-900">Your Session - Classical Music</h4>
                                        ...
                                        <div className="border border-gray-200 rounded-lg p-4 hover:border-purple-primary transition-colors">
                                            <div className="flex items-start space-x-4">
                                                ...
                                                <div className="flex-1">
                                                    <div className="flex items-center justify-between">
                                                        <h4 className="font-medium text-gray-900">Emma's Session - Art Fundamentals</h4>
                                        ...
                                        <div className="border border-gray-200 rounded-lg p-4 hover:border-green-primary transition-colors">
                                            <div className="flex items-start space-x-4">
                                                ...
                                                <div className="flex-1">
                                                    <div className="flex items-center justify-between">
                                                        <h4 className="font-medium text-gray-900">Jake's Session - Python Basics</h4>
                                                        <span className="bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full">Jake</span>
                                                    </div>
                                                    <p className="text-gray-600 text-sm">with Alex Kumar</p>
                                                    <div className="flex items-center space-x-4 mt-2 text-sm text-gray-500">
                        ...
                        <section className="mb-8">
                            <div className="flex items-center justify-between mb-6">
                                <h2 className="text-xl font-semibold text-gray-900">Young Learners Progress</h2>
                                <button className="text-primary hover:text-primary-dark text-sm font-medium">View Detailed Reports</button>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-purple-primary">
                                    <div className="flex items-center space-x-4 mb-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600 text-sm">Age 12 • Music & Art</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-200">
                                        <span className="text-sm text-gray-600">Next session: Today 4:00 PM</span>
                                        <button className="text-purple-primary hover:text-purple-600 text-sm font-medium">View Details</button>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-green-primary">
                                    <div className="flex items-center space-x-4 mb-4">
                                        ...
                                        <div>
                                            <h3 className="font-semibold text-gray-900">Jake Johnson</h3>
                                            <p className="text-gray-600 text-sm">Age 15 • Coding & Maths</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div>
                                            ...
                                            <div className="w-full bg-gray-200 rounded-full h-2">
                                                <div className="bg-green-primary h-2 rounded-full" style={{ width: '70%' }}></div>
                                            </div>
                                        </div>
                                    </div>
                                    
                                    <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-200">
                                        <span className="text-sm text-gray-600">Next session: Today 6:00 PM</span>
                                        <button className="text-green-primary hover:text-green-600 text-sm font-medium">View Details</button>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div className="bg-white rounded-xl shadow-sm p-6">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div className="flex-1">
                                            <p className="text-sm text-gray-900">Jake completed Python Basics - Module 3</p>
                                    ...
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div className="flex-1">
                                            <p className="text-sm text-gray-900">Emma received 5-star feedback from Marcus</p>
                                    ...
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div className="flex-1">
                                            <p className="text-sm text-gray-900">You booked a session with Priya Sharma</p>
                            ...
                            <div className="bg-white rounded-xl shadow-sm p-6">
                                <h3 className="text-lg font-semibold text-gray-900 mb-6">Messages & Updates</h3>
                                <div className="space-y-4">
                                    <div className="border border-gray-200 rounded-lg p-4">
                                        <div className="flex items-center space-x-3 mb-2">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-gray-500">Classical Music Mentor</p>
                                            </div>
                                        </div>
                                        <p className="text-sm text-gray-700">"Great progress in today's lesson! Looking forward to our next session."</p>
                                    ...
                                    <div className="border border-gray-200 rounded-lg p-4">
                                        <div className="flex items-center space-x-3 mb-2">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-gray-500">Programming Mentor</p>
                                            </div>
                                        </div>
                                        <p className="text-sm text-gray-700">"Jake is doing excellent work with Python. Suggested some extra practice exercises."</p>
