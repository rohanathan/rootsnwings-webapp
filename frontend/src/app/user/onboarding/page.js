...
const UserOnboardingFlow = () => {
    ...
    const predefinedInterests = [
        'Math', 'Science', 'English', 'History', 'Art', 'Music', 'Coding',
        'Robotics', 'Public Speaking', 'Photography', 'Sports', 'Cooking'
    ];
    ...
    const handleRoleToggle = (role) => {
        setFormData(prev => {
            ...
            if (currentRoles.includes(role)) {
                return { ...prev, selectedRoles: currentRoles.filter(r => r !== role) };
            } else {
    ...
    const addCustomInterest = () => {
        ...
        if (trimmedInterest && !formData.studentProfile.selectedInterests.includes(trimmedInterest)) {
    ...
    const handleNextStep = (e) => {
        ...
        if (currentStep === 3 && (!formData.studentProfile.learningGoals || formData.studentProfile.selectedInterests.length < 3)) {
            alert('Please describe your learning goals and select at least 3 interests.');
            return;
        }
        if (currentStep === 4 && (!formData.parentProfile.emergencyContactName || !formData.parentProfile.emergencyContactPhone || !formData.parentProfile.preferredContactMethod)) {
    ...
    const handleBackStep = (e) => {
        e.preventDefault();
        if (currentStep === 2 && formData.selectedRoles.includes('student') && !formData.selectedRoles.includes('parent')) {
            setCurrentStep(1);
        } else if (currentStep === 3 && formData.selectedRoles.includes('student')) {
            setCurrentStep(2);
        } else if (currentStep === 4 && formData.selectedRoles.includes('parent')) {
            setCurrentStep(3);
        } else if (currentStep === 4 && !formData.selectedRoles.includes('student')) {
            setCurrentStep(2);
    ...
    "preferredLanguages": ["english","french"],
        ...
        try {
            const response = await axios.post('https://rootsnwings-api-944856745086.europe-west2.run.app/onboarding/student/save-progress', studentData);
                ...
                <main className="flex-1 max-w-4xl mx-auto px-6 py-8 w-full">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
                        ...
                        <div className="flex items-center space-x-2 overflow-x-auto pb-2">
                            {[1, 2, 3, 4].map((step) => (
                                <>
                                    ...
                                    {step < totalSteps && <div className="w-6 h-0.5 bg-gray-300"></div>}
                                </>
                            ))}
                        </div>
                        ...
                        <div className="w-full bg-gray-300 rounded-full h-3 mt-4">
                            <div className="bg-primary h-3 rounded-full transition-all duration-500" style={{ width: progressBarWidth }}></div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 min-h-96">
                            ...
                            <form onSubmit={handleNextStep}>
                                <div className="step-content p-8" data-step="1">
                                    <div className="max-w-2xl mx-auto text-center">
                                        ...
                                        <h1 className="text-3xl font-bold text-gray-900 mb-4">Welcome to Roots & Wings!</h1>
                                        <p className="text-lg text-gray-600 mb-8">
                                            Let's complete your profile so we can personalize your learning experience.
                                        </p>
                                        ...
                                        <div className="space-y-6 text-left">
                                            ...
                                            <div>
                                                <label className="block text-sm font-medium text-gray-700 mb-2">
                                                    <i className="fas fa-user mr-2 text-primary"></i>Your Name
                                                </label>
                                                <div className="w-full px-4 py-3 border border-gray-200 rounded-xl bg-gray-50 text-gray-700">
                                                    John Smith
                                                </div>
                                                <p className="text-xs text-gray-500 mt-1">You can update this later in your profile settings</p>
                                            </div>

                                            {/* Phone Number */}
                                            <div>
                                                <label htmlFor="phone-number" className="block text-sm font-medium text-gray-700 mb-2">
                                                    <i className="fas fa-phone mr-2 text-primary"></i>Phone Number <span className="text-red-500">*</span>
                                                </label>
                                                <div className="flex">
                            ...
                            <form onSubmit={handleNextStep}>
                                <div className="step-content p-8" data-step="2">
                                    <div className="max-w-3xl mx-auto text-center">
                                        ...
                                        <h1 className="text-3xl font-bold text-gray-900 mb-4">How will you use Roots & Wings?</h1>
                                        <p className="text-lg text-gray-600 mb-8">
                                            Select all that apply. You can always add more roles later.
                                        </p>
                                        ...
                                        <div className="grid md:grid-cols-2 gap-6 text-left">
                                            ...
                                            >
                                                <div className="flex items-start space-x-4">
                                                    ...
                                                    <div className="flex-1">
                                                        <h3 className="text-xl font-semibold text-gray-900 mb-2">I want to learn</h3>
                                                        <p className="text-gray-600 mb-4">Book sessions with mentors, join workshops, and track your learning progress.</p>
                                                        <ul className="text-sm text-gray-500 space-y-1">
                                                            <li><i className="fas fa-check text-green-500 mr-2"></i>One-on-one mentoring sessions</li>
                                                            <li><i className="fas fa-check text-green-500 mr-2"></i>Group classes and workshops</li>
                                                            <li><i className="fas fa-check text-green-500 mr-2"></i>Learning progress tracking</li>
                                                        </ul>
                                                    </div>
                                                    <div className="w-6 h-6 border-2 border-gray-300 rounded flex items-center justify-center">
                                                        <i className={`fas fa-check text-primary ${!formData.selectedRoles.includes('student') ? 'hidden' : ''}`}></i>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            >
                                                <div className="flex items-start space-x-4">
                                                    ...
                                                    <div className="flex-1">
                                                        <h3 className="text-xl font-semibold text-gray-900 mb-2">I'm a parent/guardian</h3>
                                                        <p className="text-gray-600 mb-4">Manage learning experiences for your children and family members.</p>
                                                        <ul className="text-sm text-gray-500 space-y-1">
                                                            <li><i className="fas fa-check text-green-500 mr-2"></i>Create young learner profiles</li>
                                                            <li><i className="fas fa-check text-green-500 mr-2"></i>Book sessions for your children</li>
                                                            <li><i className="fas fa-check text-green-500 mr-2"></i>Family learning dashboard</li>
                                                        </ul>
                                                    </div>
                                                    <div className="w-6 h-6 border-2 border-gray-300 rounded flex items-center justify-center">
                                                        <i className={`fas fa-check text-primary ${!formData.selectedRoles.includes('parent') ? 'hidden' : ''}`}></i>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-8 p-6 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl border border-blue-200">
                                            <div className="text-center">
                                                <h4 className="text-lg font-semibold text-gray-900 mb-2">Want to become a mentor?</h4>
                                                <p className="text-gray-600 mb-4">Share your expertise and help others learn with our dedicated mentor program.</p>
                                                <a href="/become-mentor" className="inline-flex items-center px-6 py-3 bg-primary hover:bg-primary-dark text-white font-semibold rounded-xl transition-colors duration-200">
                        ...
                        {currentStep === 3 && formData.selectedRoles.includes('student') && (
                            <form onSubmit={handleNextStep}>
                                <div className="step-content p-8" data-step="3">
                                    <div className="max-w-2xl mx-auto">
                                        <div className="text-center mb-8">
                                            ...
                                            <h1 className="text-3xl font-bold text-gray-900 mb-4">Tell us about your learning goals</h1>
                                            <p className="text-lg text-gray-600">
                                                This helps us match you with the right mentors and recommend relevant workshops.
                                            </p>
                                        </div>
                                        ...
                                        <div className="space-y-6">
                                            {/* Learning Goals */}
                                            <div>
                                                <label htmlFor="learning-goals" className="block text-sm font-medium text-gray-700 mb-2">
                                                    <i className="fas fa-bullseye mr-2 text-primary"></i>What do you want to learn or achieve? <span className="text-red-500">*</span>
                                                </label>
                                                <textarea 
                                                    id="learning-goals" 
                                                    name="learningGoals"
                                                    ...
                                                    required
                                                ></textarea>
                                                <p className="text-xs text-gray-500 mt-1">Be specific about your goals - it helps mentors understand how to help you best</p>
                                            </div>

                                            {/* Interests/Subjects */}
                                            <div>
                                                <label className="block text-sm font-medium text-gray-700 mb-3">
                                                    <i className="fas fa-heart mr-2 text-primary"></i>What subjects interest you? <span className="text-red-500">*</span>
                                                </label>
                                                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                                                  {predefinedInterests.map(interest => (
                                                    <button
                                                      ...
                                                      className={`px-4 py-2 rounded-full font-medium transition-all duration-200 ${
                                                        formData.studentProfile.selectedInterests.includes(interest)
                                                  ...
                                                  {formData.studentProfile.selectedInterests.filter(i => !predefinedInterests.includes(i)).map(interest => (
                                                    <button
                                                      key={interest}
                                                      type="button"
                                                ...
                                                <p className="text-xs text-gray-500 mt-2">Select at least 3 interests that excite you</p>
                                            </div>

                                            {/* Learning Style (Optional) */}
                                            <div>
                                                <label htmlFor="learning-style" className="block text-sm font-medium text-gray-700 mb-2">
                                                    <i className="fas fa-brain mr-2 text-primary"></i>How do you prefer to learn? <span className="text-gray-400">(Optional)</span>
                                                </label>
                                                <select 
                                                    id="learning-style" 
                                                    name="learningStyle"
                                                ...
                                                >
                                                    ...
                                                    <option value="visual">Visual - I learn best with images, diagrams, and demonstrations</option>
                                                    <option value="auditory">Auditory - I learn best by listening and discussing</option>
                                                    <option value="kinesthetic">Kinesthetic - I learn best through hands-on practice</option>
                                                    <option value="mixed">Mixed - I like a combination of different approaches</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="flex justify-between items-center p-8">
                                    ...
                                    <button 
                                        ...
                                        className="px-6 py-3 bg-primary hover:bg-primary-dark text-white font-semibold rounded-xl transition-colors duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                                    >
                                        {formData.selectedRoles.includes('parent') ? 'Next Step' : 'Complete Setup'} <i className="fas fa-arrow-right ml-2"></i>
                                    </button>
                                </div>
                            </form>
                        )}
                                ...
                                <div className="step-content p-8" data-step="4">
                                    <div className="max-w-2xl mx-auto">
                                        <div className="text-center mb-8">
                                            ...
                                            <h1 className="text-3xl font-bold text-gray-900 mb-4">Parent Profile</h1>
                                            <p className="text-lg text-gray-600">
                                                Provide some information to help us support you as a parent or guardian.
                                            </p>
                                        </div>
                                        ...
                                        <div className="space-y-6">
                                            ...
                                            <div>
                                                <label htmlFor="emergency-contact-name" className="block text-sm font-medium text-gray-700 mb-2">
                                                    <i className="fas fa-user-shield mr-2 text-primary"></i>Emergency Contact Name <span className="text-red-500">*</span>
                                                </label>
                                                <input
                                                    type="text"
                                            ...
                                            <div>
                                                <label htmlFor="emergency-contact-phone" className="block text-sm font-medium text-gray-700 mb-2">
                                                    <i className="fas fa-phone-alt mr-2 text-primary"></i>Emergency Contact Phone <span className="text-red-500">*</span>
                                                </label>
                                                <input
                                                    type="tel"
                                            ...
                                            <div>
                                                <label htmlFor="preferred-contact" className="block text-sm font-medium text-gray-700 mb-2">
                                                    <i className="fas fa-hand-point-right mr-2 text-primary"></i>Preferred Contact Method <span className="text-red-500">*</span>
                                                </label>
                                                <select
                        ...
                        {currentStep === 5 && (
                            <div className="p-8">
                                <div className="max-w-2xl mx-auto text-center">
                                    ...
                                    <p className="text-lg text-gray-600 mb-8">
                                        Your profile has been created successfully. Welcome to Roots & Wings!
                                    </p>
                                    ...
                                    <div className="bg-gray-50 rounded-xl p-6 text-left border border-gray-200">
                                        ...
                                        <ul className="space-y-2 text-gray-700">
                                            ...
                                            {formData.selectedRoles.length > 0 && (
                                                <li>
                                                    <span className="font-medium">Roles:</span> {formData.selectedRoles.map(role => role.charAt(0).toUpperCase() + role.slice(1)).join(', ')}
                                                </li>
                                            )}
                                            {formData.selectedRoles.includes('student') && (
                                                <li>
                                                    <span className="font-medium">Learning Goals:</span> {formData.studentProfile.learningGoals}
                                                </li>
                                            )}
                                            {formData.selectedRoles.includes('student') && (
                                                <li>
                                                    <span className="font-medium">Interests:</span> {formData.studentProfile.selectedInterests.join(', ')}
                                                </li>
                                            )}
                                            {formData.selectedRoles.includes('student') && formData.studentProfile.learningStyle && (
                                                <li>
                                                    <span className="font-medium">Learning Style:</span> {formData.studentProfile.learningStyle.charAt(0).toUpperCase() + formData.studentProfile.learningStyle.slice(1)}
                                                </li>
                                            )}
                                            {formData.selectedRoles.includes('parent') && (
                                                <>
                                                    <li>
                                                        <span className="font-medium">Emergency Contact:</span> {formData.parentProfile.emergencyContactName}
                                                    </li>
                                                    <li>
                                                        <span className="font-medium">Contact Method:</span> {formData.parentProfile.preferredContactMethod.charAt(0).toUpperCase() + formData.parentProfile.preferredContactMethod.slice(1)}
                                                    </li>
                                                </>
                                            )}
...
onClick={handleSubmitPreferences}
                                    ...
                                    <div className="mt-8">
                                        ...
                                        {formData.selectedRoles.includes('student') && (
                                            <a href="/" className="inline-flex items-center px-6 py-3 bg-primary hover:bg-primary-dark text-white font-semibold rounded-xl transition-colors duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                                                <i className="fas fa-book-open mr-2"></i> Find a Mentor
                                            </a>
                                        )}
                                        {formData.selectedRoles.includes('parent') && (
                                            <a href="/" className="inline-flex items-center ml-4 px-6 py-3 bg-primary hover:bg-primary-dark text-white font-semibold rounded-xl transition-colors duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                                                <i className="fas fa-users mr-2"></i> Manage Learner Profiles
                                            </a>
                                        )}
                                        {!formData.selectedRoles.includes('student') && !formData.selectedRoles.includes('parent') && (
                                             <a href="/" className="inline-flex items-center px-6 py-3 bg-primary hover:bg-primary-dark text-white font-semibold rounded-xl transition-colors duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
