...
const SavedMentorsPage = () => {
    ...
    const applyFilters = () => {
      const newFilteredMentors = mentorsData.filter((mentor) => {
        const matchesLearner =
          learnerFilter === "all" || mentor.learner === learnerFilter;
  ...
  const MentorCard = ({ mentor }) => (
    <div
      className={`mentor-card bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition-all duration-200 border border-gray-200 ${mentor.hoverBorder}`}
      data-learner={mentor.learner}
      data-subject={mentor.subject}
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            className={`${mentor.buttonColor} text-white px-4 py-2 rounded-lg text-sm hover:opacity-90 transition-colors`}
          >
            Book Session
          </button>
        </div>
          ...
          <div className="flex items-center justify-between px-6 py-4">
            ...
            <div className="relative">
              ...
              >
                ...
                <i
                  className={`fas fa-chevron-down text-gray-400 text-sm transform transition-transform ${
            ...
            <div className="p-6">
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                <div className="space-y-2">
                  <button
                    className={`learner-filter w-full flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 transition-all duration-200 ease-in-out hover:bg-primary-light hover:translate-x-1 ${
                      learnerFilter === "all"
                        ? "bg-primary-light border border-primary-dark"
                        : ""
                    }`}
                    onClick={() => handleLearnerFilterClick("all")}
                  >
                  ...
                  <button
                    ...
                    onClick={() => handleLearnerFilterClick("sarah")}
                  >
                    <div className="w-8 h-8 bg-primary rounded-full flex items-center justify-center">
                  ...
                  <button
                    className={`learner-filter w-full flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 transition-all duration-200 ease-in-out hover:bg-purple-50 hover:translate-x-1 ${
                      learnerFilter === "emma"
                        ? "bg-purple-50 border border-purple-primary"
                        : ""
                    }`}
                    onClick={() => handleLearnerFilterClick("emma")}
                  >
                  ...
                  <button
                    className={`learner-filter w-full flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 transition-all duration-200 ease-in-out hover:bg-green-50 hover:translate-x-1 ${
                      learnerFilter === "jake"
                        ? "bg-green-50 border border-green-primary"
                        : ""
                    }`}
                    onClick={() => handleLearnerFilterClick("jake")}
                  >
              ...
              <div className="border-t border-gray-200 pt-6 mt-6">
                ...
                <div className="space-y-2">
                  <label className="flex items-center space-x-3 text-sm">
                    <input
                      type="checkbox"
                      className="subject-filter rounded text-primary"
                      data-subject="music"
                      checked={subjectFilters.includes("music")}
                      onChange={() => handleSubjectFilterChange("music")}
                    />
                    <span>Music (3)</span>
                  </label>
                  <label className="flex items-center space-x-3 text-sm">
                    <input
                      ...
                      className="subject-filter rounded text-primary"
                      data-subject="art"
                      checked={subjectFilters.includes("art")}
                      onChange={() => handleSubjectFilterChange("art")}
                    />
                  ...
                  <label className="flex items-center space-x-3 text-sm">
                    <input
                      ...
                      className="subject-filter rounded text-primary"
                      data-subject="coding"
                      checked={subjectFilters.includes("coding")}
                      onChange={() => handleSubjectFilterChange("coding")}
                    />
                    <span>Coding (3)</span>
                  </label>
                  <label className="flex items-center space-x-3 text-sm">
                    <input
                      ...
                      className="subject-filter rounded text-primary"
                      data-subject="maths"
                      checked={subjectFilters.includes("maths")}
                      onChange={() => handleSubjectFilterChange("maths")}
                    />
                  ...
                  <label className="flex items-center space-x-3 text-sm">
                    <input
                      ...
                      checked={subjectFilters.includes("language")}
                      onChange={() => handleSubjectFilterChange("language")}
                    />
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between">
                  <div>
                    ...
                    <p className="text-gray-600">
                      Your family's favorite mentors for easy booking
                    </p>
                  </div>
              ...
              <section>
                ...
                <div className="text-center mt-8">
                  <button className="text-primary hover:text-primary-dark font-medium">
                    Load More Mentors (
                    {mentorsData.length - filteredMentors.length} remaining)
                  </button>
                </div>
              </section>
            </div>
